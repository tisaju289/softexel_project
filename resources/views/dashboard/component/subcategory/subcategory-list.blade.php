...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="card">
      ...
      <div class="card-body">
        <div class="mb-2">
          <a href="{{ url('subCategoryCreatePage') }}" class="btn btn-success w-15">Sub Category Create</a>
        </div>
        ...
        <table class="table table-striped border border-primary">
          <thead class="thead-white text-center bg-gray border border-primary">
            <tr class="border border-primary">
              ...
              <th class="border border-white" scope="col">Sub Category Name</th>
          ...
          <tbody class="text-center border border-primary">
            ...
            <tr class="border border-primary">
                ...
                <td class="border border-primary">{{ $subcategory->name }}</td>
                <td class="border border-primary">{{ $subcategory->category->name }}</td>
                
                <td class="border border-primary">
                  <a href="{{ route('subcategory.update.page', $subcategory->id) }}" class="btn btn-primary">Edit</a>
